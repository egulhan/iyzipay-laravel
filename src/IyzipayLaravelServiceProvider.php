...
class IyzipayLaravelServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/lang/en/iyzipay.php' => resource_path('lang/en/iyzipay.php'),
        ], 'resources');

        if (!class_exists('AddBillableFields')) {
            $this->publishes([
                __DIR__ . '/../database/migrations/add_billable_fields.php.stub' => database_path('migrations/' . date('Y_m_d_His', time()) . '_add_billable_fields.php'),
            ], 'migrations');
        }
        ...
        if (!class_exists('CreatePaymentLogsTable')) {
            $this->publishes([
                __DIR__ . '/../database/migrations/create_payment_logs_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time()) . '_create_payment_logs_table.php'),
            ], 'migrations');
        }
